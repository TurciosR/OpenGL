...
void cesped(void)
{
  ...
  glTexCoord2f(0,100);    glVertex3f( -50.0f, 0.0f,  120.0f);
  glTexCoord2f(100,0);    glVertex3f(  50.0f, 0.0f,  120.0f);
  ...
  glBegin(GL_QUADS);
  glTexCoord2f(1000,1000); glVertex3f( -50.0f, 0.0f,  120.0f);
  glTexCoord2f(0,1000);    glVertex3f( -50.0f, 0.0f,  240.0f);
  glTexCoord2f(1000,0);    glVertex3f(  50.0f, 0.0f,  240.0f);
  glTexCoord2f(0,0);       glVertex3f(  50.0f, 0.0f,  120.0f);
  glEnd();
  glDisable(GL_TEXTURE_2D);
}
...
void camino(void)
{
  ...
  glTexCoord2f(0,10000); glVertex3f( -1.0f, 0.01f,  120.0f );
  glTexCoord2f(1,0);    glVertex3f(  1.0f, 0.01f,   120.0f );
  glTexCoord2f(0,0);    glVertex3f(  1.0f, 0.01f,  -60.0f );
  glEnd();
  glBegin(GL_QUADS);
  glColor3f(0.0, 0.0, 1.0);
  glTexCoord2f(1000,1000); glVertex3f( -1.0f, 0.01f,  120.0f);
  glTexCoord2f(0,1000);    glVertex3f( -1.0f, 0.01f,  240.0f);
  glTexCoord2f(1000,0);    glVertex3f(  1.0f, 0.01f,  240.0f);
  glTexCoord2f(0,0);       glVertex3f(  1.0f, 0.01f,  120.0f);
  glEnd();
